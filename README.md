...
```
$ glide get 'github.com/expectedsh/dig#^1'
$ dep ensure -add "github.com/expectedsh/dig@v1"
$ go get 'github.com/expectedsh/dig@v1'
```
...
[doc]: https://godoc.org/github.com/expectedsh/dig
